...
class ChaseRakeFeedbackVC: UIViewController {
    ...
    @IBAction func btnSubmit(_ sender: Any) {
        ...
        if isStarSelected {
            clearAllStars()
            ChaseRakeAlter.showAlert(title: "Thanks for feedback", message: "Your feedback added successfully", from: self)
        } else {
            ChaseRakeAlter.showAlert(title: "No Selection", message: "Please select a rating before submitting.", from: self)
        }
    }
